...
export default function ChampionCard({ crystal_data }) {
    ...
    return (
        <>
            ...
            <h2 className="mb-4 text-1xl font-extrabold text-center leading-none tracking-tight text-gray-400 md:text-2xl lg:text-3xl dark:text-white">{crystal_data.card_data ? `${crystal_data.card_data[0].champion} - ${crystal_data.card_data[0].value}` : null}</h2>
